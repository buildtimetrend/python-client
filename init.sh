...
BUILD_TREND_DATA_DIR=$BUILD_TREND_HOME/trends
BUILD_TREND_OUTPUTFILE=$BUILD_TREND_DATA_DIR/buildtimes.xml
BUILD_TREND_TRENDFILE=$BUILD_TREND_DATA_DIR/trend.png
