...
BUILD_TREND_DASHBOARD_DIR=$BUILD_TREND_HOME/dashboard
BUILD_TREND_OUTPUTFILE=$BUILD_TREND_DASHBOARD_DIR/buildtimes.xml
BUILD_TREND_TRENDFILE=$BUILD_TREND_DASHBOARD_DIR/trend.png
...
export BUILD_TREND_DASHBOARD_DIR
